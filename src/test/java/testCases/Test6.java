...
import com.neerajProject.pages.AppiumTestBase;
...
public class Test6 extends AppiumTestBase{
...
*/
    ...
    //@Test
    public void testTinder() throws InterruptedException, IOException {
        ...
        WebElement ele1 = appiumDriver.findElementById("rec_card_image");
        WebElement ele2 = appiumDriver.findElementById("revised_pass");
...
*/
    ...
    public void testJabong1() throws InterruptedException, IOException{
        System.out.println("App launched Test Class 6");
        Thread.sleep(15000);
        appiumDriver.findElement(By.id("button_login_real")).click();
        Thread.sleep(20000);
    ...
    public void testJabong2() throws InterruptedException, IOException{
        System.out.println(" 2 Test Test class 6 App launched2");
        Thread.sleep(15000);
        appiumDriver.findElement(By.id("button_login_real")).click();
        Thread.sleep(20000);
